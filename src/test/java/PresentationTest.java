...
class PresentationTest {
    ...
    void setUp() {
        ...
        // Note: Styles might be needed for some deeper tests, ensure they are created
        Style.createStyles();
    }
    ...
    void testSetInvalidSlideNumber() {
        ...
        assertEquals(0, presentation.getSlideNumber(), "Slide number should remain 0 after setting to 1 (out of bounds)");
        assertFalse(observer.wasUpdated(), "Observer should not be notified for invalid slide number 1");
    }
    ...
    void testObserverManagement() {
        ...
        presentation.nextSlide(); // Add another slide to allow next
        presentation.addSlide(slide2);
